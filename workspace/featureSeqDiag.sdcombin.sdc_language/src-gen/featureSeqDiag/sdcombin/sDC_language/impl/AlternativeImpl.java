 ...
 * <ul>
 *   <li>{@link featureSeqDiag.sdcombin.sDC_language.impl.AlternativeImpl#getConditionAlt <em>Condition Alt</em>}</li>
 *   <li>{@link featureSeqDiag.sdcombin.sDC_language.impl.AlternativeImpl#getContexteIF <em>Contexte IF</em>}</li>
 *   <li>{@link featureSeqDiag.sdcombin.sDC_language.impl.AlternativeImpl#getContexteELSE <em>Contexte ELSE</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AlternativeImpl extends MinimalEObjectImpl.Container implements Alternative
{
  ...
  {
    return SDC_languagePackage.Literals.ALTERNATIVE;
  }
  ...
  public NotificationChain basicSetConditionAlt(Condition newConditionAlt, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SDC_languagePackage.ALTERNATIVE__CONDITION_ALT, oldConditionAlt, newConditionAlt);
  ...
  public void setConditionAlt(Condition newConditionAlt)
  {
    if (newConditionAlt != conditionAlt)
    {
      ...
      if (conditionAlt != null)
        msgs = ((InternalEObject)conditionAlt).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SDC_languagePackage.ALTERNATIVE__CONDITION_ALT, null, msgs);
      if (newConditionAlt != null)
        msgs = ((InternalEObject)newConditionAlt).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SDC_languagePackage.ALTERNATIVE__CONDITION_ALT, null, msgs);
      msgs = basicSetConditionAlt(newConditionAlt, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SDC_languagePackage.ALTERNATIVE__CONDITION_ALT, newConditionAlt, newConditionAlt));
  }
  ...
  public EList<Contexte> getContexteIF()
  {
    if (contexteIF == null)
    {
      contexteIF = new EObjectContainmentEList<Contexte>(Contexte.class, this, SDC_languagePackage.ALTERNATIVE__CONTEXTE_IF);
    }
    return contexteIF;
  }
  ...
  public EList<Contexte> getContexteELSE()
  {
    ...
    {
      contexteELSE = new EObjectContainmentEList<Contexte>(Contexte.class, this, SDC_languagePackage.ALTERNATIVE__CONTEXTE_ELSE);
    }
    return contexteELSE;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SDC_languagePackage.ALTERNATIVE__CONDITION_ALT:
        return basicSetConditionAlt(null, msgs);
      case SDC_languagePackage.ALTERNATIVE__CONTEXTE_IF:
        return ((InternalEList<?>)getContexteIF()).basicRemove(otherEnd, msgs);
      case SDC_languagePackage.ALTERNATIVE__CONTEXTE_ELSE:
