...
* generated by Xtext
*/
package featureSeqDiag.sdcombin.services;
...
@Singleton
public class SDC_languageGrammarAccess extends AbstractGrammarElementFinder {
	...
	@Inject
	public SDC_languageGrammarAccess(GrammarProvider grammarProvider,
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("featureSeqDiag.sdcombin.SDC_language".equals(grammar.getName())) {
				return grammar;
			}
