 ...
 * <ul>
 *   <li>{@link featureSeqDiag.sdedit.sD_language.impl.SDEditAltImpl#getCondAlt <em>Cond Alt</em>}</li>
 *   <li>{@link featureSeqDiag.sdedit.sD_language.impl.SDEditAltImpl#getConseq <em>Conseq</em>}</li>
 *   <li>{@link featureSeqDiag.sdedit.sD_language.impl.SDEditAltImpl#getAlters <em>Alters</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SDEditAltImpl extends SDEditCombinedFragmentImpl implements SDEditAlt
{
  ...
  {
    return SD_languagePackage.Literals.SD_EDIT_ALT;
  }
  ...
  public NotificationChain basicSetCondAlt(Condition newCondAlt, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SD_languagePackage.SD_EDIT_ALT__COND_ALT, oldCondAlt, newCondAlt);
  ...
  public void setCondAlt(Condition newCondAlt)
  {
    if (newCondAlt != condAlt)
    {
      ...
      if (condAlt != null)
        msgs = ((InternalEObject)condAlt).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SD_languagePackage.SD_EDIT_ALT__COND_ALT, null, msgs);
      if (newCondAlt != null)
        msgs = ((InternalEObject)newCondAlt).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SD_languagePackage.SD_EDIT_ALT__COND_ALT, null, msgs);
      msgs = basicSetCondAlt(newCondAlt, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SD_languagePackage.SD_EDIT_ALT__COND_ALT, newCondAlt, newCondAlt));
  }
  ...
  public EList<SDEditCombinableDiagElt> getConseq()
  {
    if (conseq == null)
    {
      conseq = new EObjectContainmentEList<SDEditCombinableDiagElt>(SDEditCombinableDiagElt.class, this, SD_languagePackage.SD_EDIT_ALT__CONSEQ);
    }
    return conseq;
  }
  ...
  public EList<SDEditCombinableDiagElt> getAlters()
  {
    if (alters == null)
    {
      alters = new EObjectContainmentEList<SDEditCombinableDiagElt>(SDEditCombinableDiagElt.class, this, SD_languagePackage.SD_EDIT_ALT__ALTERS);
    }
    return alters;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SD_languagePackage.SD_EDIT_ALT__COND_ALT:
        return basicSetCondAlt(null, msgs);
      case SD_languagePackage.SD_EDIT_ALT__CONSEQ:
        return ((InternalEList<?>)getConseq()).basicRemove(otherEnd, msgs);
      case SD_languagePackage.SD_EDIT_ALT__ALTERS:
