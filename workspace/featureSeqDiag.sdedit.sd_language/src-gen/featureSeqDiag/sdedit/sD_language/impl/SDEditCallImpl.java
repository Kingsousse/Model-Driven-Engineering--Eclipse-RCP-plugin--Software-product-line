 ...
 * <ul>
 *   <li>{@link featureSeqDiag.sdedit.sD_language.impl.SDEditCallImpl#getCaller <em>Caller</em>}</li>
 *   <li>{@link featureSeqDiag.sdedit.sD_language.impl.SDEditCallImpl#getReturnMessage <em>Return Message</em>}</li>
 *   <li>{@link featureSeqDiag.sdedit.sD_language.impl.SDEditCallImpl#getCalled <em>Called</em>}</li>
 *   <li>{@link featureSeqDiag.sdedit.sD_language.impl.SDEditCallImpl#getName <em>Name</em>}</li>
 *   <li>{@link featureSeqDiag.sdedit.sD_language.impl.SDEditCallImpl#getParams <em>Params</em>}</li>
 *   <li>{@link featureSeqDiag.sdedit.sD_language.impl.SDEditCallImpl#getParamLists <em>Param Lists</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SDEditCallImpl extends SDEditCombinableDiagEltImpl implements SDEditCall
{
  ...
  {
    return SD_languagePackage.Literals.SD_EDIT_CALL;
  }
    ...
    if (caller != null && caller.eIsProxy())
    {
      ...
      if (caller != oldCaller)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, SD_languagePackage.SD_EDIT_CALL__CALLER, oldCaller, caller));
      }
    }
    return caller;
  }
  ...
  public void setCaller(SDEditObjname newCaller)
  {
    ...
    caller = newCaller;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SD_languagePackage.SD_EDIT_CALL__CALLER, oldCaller, caller));
  }
  ...
  public void setReturnMessage(String newReturnMessage)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SD_languagePackage.SD_EDIT_CALL__RETURN_MESSAGE, oldReturnMessage, returnMessage));
  }
  ...
  public SDEditObjname getCalled()
  {
    if (called != null && called.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, SD_languagePackage.SD_EDIT_CALL__CALLED, oldCalled, called));
      }
    }
    return called;
  }
  ...
  public void setCalled(SDEditObjname newCalled)
  {
    ...
    called = newCalled;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SD_languagePackage.SD_EDIT_CALL__CALLED, oldCalled, called));
  }
  ...
  public void setName(String newName)
  {
    ...
    name = newName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SD_languagePackage.SD_EDIT_CALL__NAME, oldName, name));
  }
  ...
  public void setParams(String newParams)
  {
    ...
    params = newParams;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SD_languagePackage.SD_EDIT_CALL__PARAMS, oldParams, params));
  }
  ...
  public EList<String> getParamLists()
  {
    if (paramLists == null)
    {
      paramLists = new EDataTypeEList<String>(String.class, this, SD_languagePackage.SD_EDIT_CALL__PARAM_LISTS);
    }
    return paramLists;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SD_languagePackage.SD_EDIT_CALL__CALLER:
        if (resolve) return getCaller();
        return basicGetCaller();
      case SD_languagePackage.SD_EDIT_CALL__RETURN_MESSAGE:
        return getReturnMessage();
      case SD_languagePackage.SD_EDIT_CALL__CALLED:
        if (resolve) return getCalled();
        return basicGetCalled();
      case SD_languagePackage.SD_EDIT_CALL__NAME:
        return getName();
      case SD_languagePackage.SD_EDIT_CALL__PARAMS:
        return getParams();
      case SD_languagePackage.SD_EDIT_CALL__PARAM_LISTS:
