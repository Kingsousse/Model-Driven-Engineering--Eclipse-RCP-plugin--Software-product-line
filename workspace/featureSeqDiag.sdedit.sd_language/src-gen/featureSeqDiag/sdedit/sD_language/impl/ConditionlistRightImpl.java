 ...
 * <ul>
 *   <li>{@link featureSeqDiag.sdedit.sD_language.impl.ConditionlistRightImpl#getCondRight <em>Cond Right</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConditionlistRightImpl extends MinimalEObjectImpl.Container implements ConditionlistRight
{
  ...
  {
    return SD_languagePackage.Literals.CONDITIONLIST_RIGHT;
  }
  ...
  public NotificationChain basicSetCondRight(ConditionElm newCondRight, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SD_languagePackage.CONDITIONLIST_RIGHT__COND_RIGHT, oldCondRight, newCondRight);
  ...
  public void setCondRight(ConditionElm newCondRight)
  {
    if (newCondRight != condRight)
    {
      ...
      if (condRight != null)
        msgs = ((InternalEObject)condRight).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SD_languagePackage.CONDITIONLIST_RIGHT__COND_RIGHT, null, msgs);
      if (newCondRight != null)
        msgs = ((InternalEObject)newCondRight).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SD_languagePackage.CONDITIONLIST_RIGHT__COND_RIGHT, null, msgs);
      msgs = basicSetCondRight(newCondRight, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SD_languagePackage.CONDITIONLIST_RIGHT__COND_RIGHT, newCondRight, newCondRight));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SD_languagePackage.CONDITIONLIST_RIGHT__COND_RIGHT:
