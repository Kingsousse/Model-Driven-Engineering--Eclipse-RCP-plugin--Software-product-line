 ...
 * <ul>
 *   <li>{@link sdedit.sDELang.impl.ConditionElmImpl#getOperandN <em>Operand N</em>}</li>
 *   <li>{@link sdedit.sDELang.impl.ConditionElmImpl#getOperandStr <em>Operand Str</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConditionElmImpl extends MinimalEObjectImpl.Container implements ConditionElm
{
  ...
  {
    return SDELangPackage.Literals.CONDITION_ELM;
  }
  ...
  public void setOperandN(int newOperandN)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SDELangPackage.CONDITION_ELM__OPERAND_N, oldOperandN, operandN));
  }
  ...
  public void setOperandStr(String newOperandStr)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SDELangPackage.CONDITION_ELM__OPERAND_STR, oldOperandStr, operandStr));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SDELangPackage.CONDITION_ELM__OPERAND_N:
        return getOperandN();
      case SDELangPackage.CONDITION_ELM__OPERAND_STR:
