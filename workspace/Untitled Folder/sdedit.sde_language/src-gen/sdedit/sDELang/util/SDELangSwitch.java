 ...
 * @generated
 */
public class SDELangSwitch<T> extends Switch<T>
{
  /**
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case SDELangPackage.SD_EDIT_COMBINABLE_DIAG_ELT:
      {
      ...
      case SDELangPackage.SD_EDIT_COMBINED_FRAGMENT:
      {
