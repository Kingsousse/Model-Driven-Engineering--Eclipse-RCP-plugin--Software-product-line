 ...
 * <ul>
 *   <li>{@link sdedit.sDELang.impl.SDEditModelImpl#getElements <em>Elements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SDEditModelImpl extends MinimalEObjectImpl.Container implements SDEditModel
{
  ...
  {
    return SDELangPackage.Literals.SD_EDIT_MODEL;
  }
  ...
  public EList<EObject> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<EObject>(EObject.class, this, SDELangPackage.SD_EDIT_MODEL__ELEMENTS);
    }
    return elements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SDELangPackage.SD_EDIT_MODEL__ELEMENTS:
